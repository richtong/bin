...
_gh_pr_create()
{
    ...
    local_nonpersistent_flags+=("--milestone=")
    local_nonpersistent_flags+=("-m")
    flags+=("--no-maintainer-edit")
    local_nonpersistent_flags+=("--no-maintainer-edit")
    flags+=("--project=")
    two_word_flags+=("--project")
    two_word_flags+=("-p")
    local_nonpersistent_flags+=("--project")
...
_gh_repo_fork()
{
    ...
    flags+=("--remote-name=")
    two_word_flags+=("--remote-name")
    local_nonpersistent_flags+=("--remote-name")
    local_nonpersistent_flags+=("--remote-name=")
    flags+=("--help")
